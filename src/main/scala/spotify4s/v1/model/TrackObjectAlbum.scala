...
case class TrackObjectAlbum (
  ...
  albumType: TrackObjectAlbumEnums.AlbumType,
  ...
  releaseDatePrecision: TrackObjectAlbumEnums.ReleaseDatePrecision,
  restrictions: Option[AlbumBaseRestrictions] = None,
  /* The object type.  */
  `type`: TrackObjectAlbumEnums.`Type`,
  ...
  albumGroup: Option[TrackObjectAlbumEnums.AlbumGroup] = None,
  /* The artists of the album. Each artist object includes a link in `href` to more detailed information about the artist.  */
  artists: List[SimplifiedArtistObject]
)

object TrackObjectAlbumEnums {
