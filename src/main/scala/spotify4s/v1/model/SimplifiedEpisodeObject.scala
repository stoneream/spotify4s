...
case class SimplifiedEpisodeObject (
  ...
  releaseDatePrecision: SimplifiedEpisodeObjectEnums.ReleaseDatePrecision,
  resumePoint: EpisodeBaseResumePoint,
  /* The object type.  */
  `type`: SimplifiedEpisodeObjectEnums.`Type`,
...
object SimplifiedEpisodeObjectEnums {
