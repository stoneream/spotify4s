...
case class PlaylistTrackObjectTrack (
  ...
  /* The object type.  */
  `type`: PlaylistTrackObjectTrack.`Type`,
  ...
  releaseDatePrecision: PlaylistTrackObjectTrack.ReleaseDatePrecision,
  resumePoint: EpisodeBaseResumePoint,
  show: SimplifiedShowObject
)

object PlaylistTrackObjectTrack {
  implicit val format: Format[PlaylistTrackObjectTrack] = Json.format[PlaylistTrackObjectTrack]
