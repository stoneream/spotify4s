...
case class SegmentObject (
  ...
  loudnessStart: Option[BigDecimal] = None,
  ...
  loudnessMax: Option[BigDecimal] = None,
  ...
  loudnessMaxTime: Option[BigDecimal] = None,
  /* The offset loudness of the segment in decibels (dB). This value should be equivalent to the loudness_start of the following segment. */
  loudnessEnd: Option[BigDecimal] = None,
  ...
  pitches: Option[List[BigDecimal]] = None,
  ...
  timbre: Option[List[BigDecimal]] = None
)

object SegmentObject {
  implicit val format: Format[SegmentObject] = Json.format[SegmentObject]
