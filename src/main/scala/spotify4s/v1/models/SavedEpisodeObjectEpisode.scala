...
case class SavedEpisodeObjectEpisode (
  ...
  releaseDatePrecision: SavedEpisodeObjectEpisode.ReleaseDatePrecision,
  resumePoint: EpisodeBaseResumePoint,
  /* The object type.  */
  `type`: SavedEpisodeObjectEpisode.`Type`,
...
object SavedEpisodeObjectEpisode {
  implicit val format: Format[SavedEpisodeObjectEpisode] = Json.format[SavedEpisodeObjectEpisode]
