...
case class ChapterObject (
  ...
  releaseDatePrecision: ChapterObject.ReleaseDatePrecision,
...
object ChapterObject {
  implicit val format: Format[ChapterObject] = Json.format[ChapterObject]
