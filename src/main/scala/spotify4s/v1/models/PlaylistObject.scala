...
case class PlaylistObject (
  ...
  followers: Option[PlaylistObjectFollowers] = None,
  ...
  tracks: Option[PlaylistObjectTracks] = None,
...
object PlaylistObject {
  implicit val format: Format[PlaylistObject] = Json.format[PlaylistObject]
