...
object CurrentlyPlayingContextObjectActions {
  implicit val format: Format[CurrentlyPlayingContextObjectActions] = Json.format[CurrentlyPlayingContextObjectActions]
