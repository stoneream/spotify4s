...
case class SimplifiedAlbumObject (
  ...
  albumType: SimplifiedAlbumObject.AlbumType,
  ...
  releaseDatePrecision: SimplifiedAlbumObject.ReleaseDatePrecision,
  restrictions: Option[AlbumBaseRestrictions] = None,
  /* The object type.  */
  `type`: SimplifiedAlbumObject.`Type`,
  ...
  albumGroup: Option[SimplifiedAlbumObject.AlbumGroup] = None,
  /* The artists of the album. Each artist object includes a link in `href` to more detailed information about the artist.  */
  artists: List[SimplifiedArtistObject]
)

object SimplifiedAlbumObject {
  implicit val format: Format[SimplifiedAlbumObject] = Json.format[SimplifiedAlbumObject]
