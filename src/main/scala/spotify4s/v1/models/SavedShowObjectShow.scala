...
case class SavedShowObjectShow (
  ...
  publisher: String,
  /* The object type.  */
  `type`: SavedShowObjectShow.`Type`,
  /* The [Spotify URI](/documentation/web-api/#spotify-uris-and-ids) for the show.  */
  uri: String
)

object SavedShowObjectShow {
  implicit val format: Format[SavedShowObjectShow] = Json.format[SavedShowObjectShow]
