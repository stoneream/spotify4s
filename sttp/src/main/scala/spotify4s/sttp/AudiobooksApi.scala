...
object AudiobooksApi {
   ...
   */
  def getAnAudiobook(id: String, market: Option[String])(client: SttpBackend[Identity, Any]) = {
   ...
   * Note: Audiobooks are only available for the US, UK, Ireland, New Zealand and Australia markets.
   */
  def getMultipleAudiobooks(ids: String, market: Option[String])(client: SttpBackend[Identity, Any]) = {
