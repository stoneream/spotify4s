...
object CategoriesApi {
   ...
   */
  def getACategory(categoryId: String, country: Option[String], locale: Option[String])(client: SttpBackend[Identity, Any]): Either[ResponseException[ErrorObject, circe.Error], CategoryObject] = {
   ...
   */
  def getCategories(country: Option[String], locale: Option[String], limit: Option[Int], offset: Option[Int])(client: SttpBackend[Identity, Any]): Either[ResponseException[ErrorObject, circe.Error], GetCategories200Response] = {
