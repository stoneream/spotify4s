...
object ShowsApi {
   ...
   */
  def getAShow(id: String, market: Option[String])(client: SttpBackend[Identity, Any]) = {
   ...
   */
  def getMultipleShows(ids: String, market: Option[String])(client: SttpBackend[Identity, Any]) = {
