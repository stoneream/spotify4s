...
case class CurrentlyPlayingObjectItem(
    ...
    /* The object type.  */
    `type`: CurrentlyPlayingObjectItemEnums.`Type`,
    ...
    releaseDatePrecision: CurrentlyPlayingObjectItemEnums.ReleaseDatePrecision,
    resumePoint: EpisodeBaseResumePoint,
    show: SimplifiedShowObject
)

object CurrentlyPlayingObjectItemEnums {
